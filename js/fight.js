...
export function generateFight(fighter1, fighter2) {
  ...
  while (fighter1.isAlive() && fighter2.isAlive()) {
    ...
    history += `${attacker.nickname} envoie ${damage.dealtDamages} de dégats à ${defender.nickname}, ${defender.nickname} a pu se défendre et a tanké ${damage.absorbedDamages} de dégats. Ainsi, ${defender.nickname} a reçu ${damage.trueDamages} dégâts réels.\n`;
